               ...
               <li className="mb-[1rem] last:mb-0" >
                    <div className="relative pl-[1.125rem]">
                                          ...
                                          : list_color === "warning"
                                            ...
                                            : list_color === "danger"
                                              ...
                                              : list_color === "secondary"
                                                ...
                                                : ""
                              }  h-[7px] w-[7px] outline-[4px] rounded-full outline absolute top-[7px] -left-[10px]`}
                         ></div>
                         ...
                         <div className="flex items-start justify-between">
                              ...
                              <div>
                                   {/* name and percentage */}
                                   <h5 className="text-dark font-semibold text-button ">
                                        {product.name} ({product.percentage}%)
                                   </h5>
                                   <span className="text-admin text-vsm uppercase font-semibold">
                              ...
                              {/* total revenue */}
                              <div>
                                   <span className="text-dark font-semibold text-button">
                                        $ {product.revenue}
                                   </span>
                              </div>
                         </div>
