                    ...
                    <AreaChart
                        ...
                        <defs>
                            <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor="rgba(255, 133, 72, 0.37)" />
                                <stop offset="95%" stopColor="rgba(255, 133, 72, 0.00)" />
                            </linearGradient>
                        </defs>
                        ...
                        <Tooltip />
                        <Area type="monotone" dataKey="pv" strokeWidth={3} stroke="#FF8548" fill="url(#colorUv)" />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
        </>
