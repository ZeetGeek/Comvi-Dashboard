...
function Sidebar() {
     return (
          <>
               <div
                    className={` ${style.sidebar} h-full bg-primary overflow-auto`}
               >
                         ...
                         <div className=" px-[1.5rem] pb-[1.5rem] mt-[3.125rem]">
                              <div className="rounded-md p-[1.5rem] bg-slider-add-bg relative overflow-hidden">
                                   ...
                                   <div className="mb-[8rem] relative z-[2]">
                                        <h5 className="text-white text-3xl capitalize font-bold ">
                                   ...
                                   <div className="relative z-[2]">
                                        <Button className="w-full" size="medium" color="warning" name="start now"  >
                                             Start Now
                                        </Button>
                                   </div>
                              </div>
